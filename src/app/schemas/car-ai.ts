...
export const CarTaxonomyAISchema = z.object({
...
export const CarDetailsAISchema = z.object({
	description: z
		.string()
		.describe(
...
export const CarAISchema = CarDetailsAISchema.merge(
	CarTaxonomyAISchema,
).extend({
...
export type CarAI = z.infer<typeof CarAISchema>;